...
CREATE TABLE `CONTRACTS` (
  ...
  KEY `userID_CONTRACTS` (`clientID_CONTRACTS`),
  KEY `tariffID_CONTRACTS` (`tariffID_CONTRACTS`),
  KEY `blockedEmpID_CONTRACTS` (`blockedEmpId_CONTRACTS`),
  CONSTRAINT `tariffID_CONTRACTS` FOREIGN KEY (`tariffID_CONTRACTS`) REFERENCES `TARIFFS` (`id_TARIFFS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `blockedEmpID_CONTRACTS` FOREIGN KEY (`blockedEmpId_CONTRACTS`) REFERENCES `USERS` (`id_USERS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `userID_CONTRACTS` FOREIGN KEY (`clientID_CONTRACTS`) REFERENCES `USERS` (`id_USERS`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `CONTRACT_OPTION` (
  ...
  KEY `contractID_CONTRACT_OPTION` (`contractID_CONTRACT_OPTION`),
  KEY `optionID_CONTRACT_OPTION` (`optionID_CONTRACT_OPTION`),
  CONSTRAINT `contractID_CONTRACT_OPTION` FOREIGN KEY (`contractID_CONTRACT_OPTION`) REFERENCES `CONTRACTS` (`id_CONTRACTS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `optionID_CONTRACT_OPTION` FOREIGN KEY (`optionID_CONTRACT_OPTION`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OPTIONS_INCOMPATIBLE` (
  ...
  KEY `optionOneID_OPTIONS_INCOMPATIBLE` (`optionOneID_OPTIONS_INCOMPATIBLE`),
  KEY `optionTwoID_OPTIONS_INCOMPATIBLE` (`optionTwoID_OPTIONS_INCOMPATIBLE`),
  CONSTRAINT `optionOneID_OPTIONS_INCOMPATIBLE` FOREIGN KEY (`optionOneID_OPTIONS_INCOMPATIBLE`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `optionTwoID_OPTIONS_INCOMPATIBLE` FOREIGN KEY (`optionTwoID_OPTIONS_INCOMPATIBLE`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OPTIONS_TOGETHER` (
  ...
  KEY `optionOneID_OPTIONS_TOGETHER` (`optionOneID_OPTIONS_TOGETHER`),
  KEY `optionTwoID_OPTIONS_TOGETHER` (`optionTwoID_OPTIONS_TOGETHER`),
  CONSTRAINT `optionOneID_OPTIONS_TOGETHER` FOREIGN KEY (`optionOneID_OPTIONS_TOGETHER`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `optionTwoID_OPTIONS_TOGETHER` FOREIGN KEY (`optionTwoID_OPTIONS_TOGETHER`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TARIFF_RULES` (
  ...
  `idPossibleOption_TARIFF_RULES` int(11) NOT NULL,
  PRIMARY KEY (`id_TARIFF_RULES`),
  UNIQUE KEY `id_TARIFF_RULES_UNIQUE` (`id_TARIFF_RULES`),
  KEY `idTariff_TARIFF_RULES` (`idTariff_TARIFF_RULES`),
  KEY `idPossibleOption_TARIFF_RULES` (`idPossibleOption_TARIFF_RULES`),
  CONSTRAINT `idTariff_TARIFF_RULES` FOREIGN KEY (`idTariff_TARIFF_RULES`) REFERENCES `TARIFFS` (`id_TARIFFS`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idPossibleOption_TARIFF_RULES` FOREIGN KEY (`idPossibleOption_TARIFF_RULES`) REFERENCES `OPTIONS` (`id_OPTIONS`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USERS` (
  ...
  CONSTRAINT `role_USERS` FOREIGN KEY (`role_USERS`) REFERENCES `ROLES` (`id_ROLES`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-10-16 10:34:48
