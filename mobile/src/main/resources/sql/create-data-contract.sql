...
INSERT INTO `tproject`.`CONTRACTS` (`id`, `blocked`, `number`, `tariff_id`, `user_id`) VALUES (213698745, 0, 2030508090, 211369877, 299999998);
INSERT INTO `tproject`.`CONTRACTS` (`id`, `blocked`, `number`, `tariff_id`, `user_id`) VALUES (213698746, 0, 2030508091, 211369877, 299999998);
