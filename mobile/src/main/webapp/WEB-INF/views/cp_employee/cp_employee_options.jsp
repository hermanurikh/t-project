...
<div id="new_user" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-draggable ui-resizable ui-widget-shadow" tabindex="-1" role="dialog" aria-describedby="ftp_user_dialog" aria-labelledby="ui-id-7" style="position: absolute; height: auto; width: 640px; top: 99.5px; left: 360px; display: none;">
    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"><span id="ui-id-7" class="ui-dialog-title">Новая опция</span>
    ...
    <div id="ftp_user_dialog" class="ui-dialog-content ui-widget-content" style="width: auto; min-height: 76px; max-height: none; height: auto;">
        <div class="form-horizontal npp_ftp-dialog_middle">
            ...
            <form name="myForm" action="cp_employee_option_created" id="jForm" method="POST" accept-charset="CP1252">
                <div class="js-body info__body">
                    <div>
                        <div class="js-table form-horizontal support-issue-form">
                            ...
                            <h2 class="js-h">Выберите опции, которые будут обязательны для данной опции</h2>
                            <div>
                                            ...
                                            <c:forEach var="option" items="${optionsList}">
                                                <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                                                    ...
                                                    <td name="tcell" class="simplecell_checkbox" align="left">
                                                        <input type="checkbox" onchange="recheck (this, '${option.id}600' );" name="cb" id=${option.id}300 value=${option.id}>
                                                    </td>
                                ...
                                <h2 class="js-h">Выберите опции, которые будут несовместимы с данной опцией</h2>
                                <div>
                                            ...
                                            <table class="ui-table ui-table-hover ui-table-striped" style="width:100%">
                                                ...
                                                <c:forEach var="option" items="${optionsList}">
                                                    <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                                                        ...
                                                        <td name="tcell" class="simplecell_checkbox" align="left">
                                                            <input type="checkbox" onchange="recheck (this, '${option.id}300' );" name="cb2" id=${option.id}600 value=${option.id}>
                                                        </td>
                                                        <td class="simplecell" name="tcell" style="vertical-align: top; width: 150px"><span>${option.name}</span>
                                                            <br>
                                                        </td>
    ...
    <table class="element__table element-main-table">
        ...
        <tr>
            <td class="element__block">
                ...
                <div class="info-wrap">
                    <div>
                        <a onclick="showMenu()"><span>Создание новой опции</span></a>
                    </div>
            ...
            <c:forEach var="option" items="${optionsList}">
                <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                    ...
                    <td class="simplecell" name="tcell" style="vertical-align: top;">
                        <div class="href_icon">
                            <a href="cp_employee_delete_option?optionId=${option.id}" onclick="wait()"><span>Удалить</span><br> </a>
                            <a href="cp_employee_change_option?optionId=${option.id}" onclick="wait()"><span>Изменить</span> </a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
