                ...
                <div class="form-horizontal">
                    <div class="control-group">
                        ...
                        <div id="info-data" class="controls">
                            <!-- user info -->
                            <div id="table-description0"><h3>Просмотр контракта ${contract.number}</h3><table class="npp_info info-table"><tbody><tr>
                                <td>
                                ...
                                <td>
                                    <div class="info-data js-def"><label>${contract.tariff.name}</label></div>
                                </td>
                            </tr><tr>
                                <td>
                                    <div class="help-underline help-underline-light">
                                ...
                                <td>
                                    <div class="info-data js-def"><label>${contract.tariff.price}</label></div>
                                </td>
                            </tr></tbody></table></div><div id="table-description1"><h3>Подключенные опции</h3><table class="npp_info info-table"><tbody>
                            ...
                            <td>
                                <div class="info-data js-def"><label>${option.price} р./мес.</label></div>
                            </td>
                        </tr>
                        </c:forEach>
                        ...
                        <tr>
                                                    ...
                                                    <td>
                                                        <div class="info-data js-def"><label>${totalAmount} р./мес.</label></div>
                                                    </td>
                                                </tr>
