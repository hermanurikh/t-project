...
public class OptionServiceImplementationTest extends AbstractJUnit4SpringContextTests {
    ...
    /*private static final String CREATE_SCRIPT = "mobile/src/main/resources/sql/create-data-option.sql";
    private static final String DELETE_SCRIPT = "mobile/src/main/resources/sql/remove-data-option.sql";*/

    private static final String CREATE_SCRIPT = "src/main/resources/sql/create-data-option.sql";
    private static final String DELETE_SCRIPT = "src/main/resources/sql/remove-data-option.sql";
    private static final int OPTION_ID = 214561783;
    private static final int OPTION_PRICE = 14041992;
    ...
    public void testOptionUpdate() {
        ...
        option.setInitialPrice(OPTION_PRICE);
        ...
        assertTrue(option.getInitialPrice() == OPTION_PRICE);
    ...
    public void testOptionDelete() {
        Option option = optionService.getEntityById(OPTION_ID);
        optionService.deleteEntity(option);
        assertNull(optionService.getEntityById(OPTION_ID));
    }
