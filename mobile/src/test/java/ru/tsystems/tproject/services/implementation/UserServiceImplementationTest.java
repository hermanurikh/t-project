...
public class UserServiceImplementationTest extends AbstractJUnit4SpringContextTests {
    ...
    /*private static final String CREATE_SCRIPT = "mobile/src/main/resources/sql/create-data-user.sql";
    private static final String DELETE_SCRIPT = "mobile/src/main/resources/sql/remove-data-user.sql";*/
    private static final String CREATE_SCRIPT = "src/main/resources/sql/create-data-user.sql";
    private static final String DELETE_SCRIPT = "src/main/resources/sql/remove-data-user.sql";

    private static final String USER_LOGIN = "1poi3JUShN76c";
    @Before
    ...
    public void testUserDelete() {
        User user = userService.getUserByLogin(USER_LOGIN);
        userService.deleteEntity(user);
        userService.getUserByLogin(USER_LOGIN);
    }
