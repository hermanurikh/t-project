...
public class TariffServiceImplementationTest extends AbstractJUnit4SpringContextTests {
    ...
    private static final int TARIFF_ID = 211369877;
    private static final int TARIFF_PRICE = 89765;
    ...
    public void testTariffRead() {
        Tariff tariff = tariffService.getEntityById(TARIFF_ID);
    ...
    public void testTariffUpdate() {
        ...
        assertTrue(tariff.getPrice() == TARIFF_PRICE);
    ...
    public void testTariffDelete() {
        Tariff tariff = tariffService.getEntityById(TARIFF_ID);
        tariffService.deleteEntity(tariff);
        assertNull(tariffService.getEntityById(TARIFF_ID));
    }
