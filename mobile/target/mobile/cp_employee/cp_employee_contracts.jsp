                                                ...
                                                <div class="account-selector dobble">
                                                    <div class="main">
                                                        <div class="info">
                                                            ...
                                                            <div class="username">gurikh<span class="shad">&nbsp;</span>
                                                            </div>
                                ...
                                <tr>
                                    <td class="content np_menu">
                                        <div id="np_menu_id" class="wrap-for-hover">
                                            ...
                                            <div><a class="js-return-to-old return-to-old ui-corner-all ui-button-text-only" href="../login.html"><i class="icon-back-arrow"></i><span>Выход из аккаунта</span></a>
                                            </div>
                                            &nbsp;</div>
                                    </td>
                                    <!--np_menu-->
