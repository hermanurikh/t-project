                    ...
                    <table class="element__table element-main-table">
                        ...
                        <tr>
                            <td class="element__block">
                                ...
                                <div class="info-wrap">
                                    <div>
                                        <a href="cp_employee_new_option"><span>Создание новой опции</span></a>
                                    </div>
                ...
                <div id="list_database">
                    <div style="">
                        ...
                        <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                            ...
                            <div class="href_icon">
                                <a href="cp_employee_delete_option?optionId=${option.id}"><span>Удалить</span><br> </a>
                                <a href="cp_employee_change_option?optionId=${option.id}"><span>Изменить</span> </a>
                            </div>
                            </td>
                        </tr>
                        </c:forEach>
