                        ...
                        <c:forEach var="tariff" items="${tariffsList}">
                            <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                                ...
                                <td class="simplecell" name="tcell" style="vertical-align: top;">
                                    <div class="href_icon">
                                        <a href="cp_employee_change_tariff?id=${tariff.id}" onclick="wait()"><span>Изменить</span><br> </a>
                                        <a href="cp_employee_delete_tariff?id=${tariff.id}" onclick="wait()"><span>Удалить</span> </a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
